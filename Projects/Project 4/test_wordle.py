...
def test_wordle_one_try_one_guess_win(group_name): ...
...
def test_wordle_5_tries_one_guess_win(group_name): ...
...
def test_wordle_two_tries_two_guesses_win(group_name): ...
...
def test_wordle_three_tries_three_guesses_loss(group_name): ...
...
def test_wordle_correct_letters_but_wrong_spots(group_name): ...
...
def test_wordle_duplicate_letters_one_correct_one_close(group_name): ...
...
def test_wordle_correct_word_has_doubles(group_name): ...
...
def test_wordle_numbers_and_symbols(group_name): ...
...
def test_wordle_six_guesses_loss(group_name): ...
...
def test_wordle_real_game(group_name): ...
